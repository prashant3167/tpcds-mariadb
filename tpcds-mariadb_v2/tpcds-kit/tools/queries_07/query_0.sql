...
-- end query 1 in stream 0 using template query96.tpl--I am here
...
-- end query 2 in stream 0 using template query7.tpl--I am here
...
-- end query 3 in stream 0 using template query75.tpl--I am here
...
-- end query 4 in stream 0 using template query44.tpl--I am here
...
-- end query 5 in stream 0 using template query39.tpl--I am here
...
-- end query 6 in stream 0 using template query80.tpl--I am here
...
-- end query 7 in stream 0 using template query32.tpl--I am here
...
-- end query 8 in stream 0 using template query19.tpl--I am here
...
-- end query 9 in stream 0 using template query25.tpl--I am here
...
-- end query 10 in stream 0 using template query78.tpl--I am here
...
-- end query 11 in stream 0 using template query86.tpl--I am here
...
-- end query 12 in stream 0 using template query1.tpl--I am here
...
-- end query 13 in stream 0 using template query91.tpl--I am here
...
-- end query 14 in stream 0 using template query21.tpl--I am here
...
-- end query 15 in stream 0 using template query43.tpl--I am here
...
-- end query 16 in stream 0 using template query27.tpl--I am here
...
-- end query 17 in stream 0 using template query94.tpl--I am here
...
-- end query 18 in stream 0 using template query45.tpl--I am here
...
-- end query 19 in stream 0 using template query58.tpl--I am here
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('blanched','mint','firebrick','chiffon','beige','floral') and
...
-- end query 20 in stream 0 using template query64.tpl--I am here
...
-- end query 21 in stream 0 using template query36.tpl--I am here
...
-- end query 22 in stream 0 using template query33.tpl--I am here
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Fairview','Oak Grove','Five Points','Midway','Fairview') 
...
-- end query 23 in stream 0 using template query46.tpl--I am here
...
-- end query 24 in stream 0 using template query62.tpl--I am here
...
-- end query 25 in stream 0 using template query16.tpl--I am here
...
select  
 ...
 where
  ...
  ca_county in ('Rock County','Mahoning County','Potter County','Manassas Park city','Lake and Peninsula Borough') and
...
-- end query 26 in stream 0 using template query10.tpl--I am here
...
-- end query 27 in stream 0 using template query63.tpl--I am here
...
-- end query 28 in stream 0 using template query69.tpl--I am here
...
-- end query 29 in stream 0 using template query60.tpl--I am here
...
-- end query 30 in stream 0 using template query59.tpl--I am here
...
-- end query 31 in stream 0 using template query37.tpl--I am here
...
-- end query 32 in stream 0 using template query98.tpl--I am here
...
-- end query 33 in stream 0 using template query85.tpl--I am here
...
-- end query 34 in stream 0 using template query70.tpl--I am here
...
-- end query 35 in stream 0 using template query67.tpl--I am here
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 19 and 19+10
          or ss_coupon_amt between 4296 and 4296+1000
...
-- end query 36 in stream 0 using template query28.tpl--I am here
...
-- end query 37 in stream 0 using template query81.tpl--I am here
...
-- end query 38 in stream 0 using template query97.tpl--I am here
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 3532 and 3532+28800 
...
-- end query 39 in stream 0 using template query66.tpl--I am here
...
-- end query 40 in stream 0 using template query90.tpl--I am here
...
-- end query 41 in stream 0 using template query17.tpl--I am here
...
-- end query 42 in stream 0 using template query47.tpl--I am here
...
-- end query 43 in stream 0 using template query95.tpl--I am here
...
-- end query 44 in stream 0 using template query92.tpl--I am here
...
-- end query 45 in stream 0 using template query3.tpl--I am here
...
-- end query 46 in stream 0 using template query51.tpl--I am here
...
-- end query 47 in stream 0 using template query35.tpl--I am here
...
-- end query 48 in stream 0 using template query49.tpl--I am here
-- start query 49 in stream 0 using template query9.tpl
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 282651
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 41806
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 268292
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 172746
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 322549
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
-- end query 49 in stream 0 using template query9.tpl--I am here
...
-- end query 50 in stream 0 using template query31.tpl--I am here
...
-- end query 51 in stream 0 using template query11.tpl--I am here
...
-- end query 52 in stream 0 using template query93.tpl--I am here
...
-- end query 53 in stream 0 using template query29.tpl--I am here
...
-- end query 54 in stream 0 using template query38.tpl--I am here
...
-- end query 55 in stream 0 using template query22.tpl--I am here
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Music','Children','Jewelry') and
          i_class in ('classical','infants','diamonds')
         )
      or (i_category in ('Shoes','Sports','Men') and
          i_class in ('mens','tennis','pants') 
        ))
...
-- end query 56 in stream 0 using template query89.tpl--I am here
...
-- end query 57 in stream 0 using template query15.tpl--I am here
...
-- end query 58 in stream 0 using template query6.tpl--I am here
...
-- end query 59 in stream 0 using template query52.tpl--I am here
...
-- end query 60 in stream 0 using template query50.tpl--I am here
...
-- end query 61 in stream 0 using template query42.tpl--I am here
...
-- end query 62 in stream 0 using template query41.tpl--I am here
...
-- end query 63 in stream 0 using template query8.tpl--I am here
...
-- end query 64 in stream 0 using template query12.tpl--I am here
...
-- end query 65 in stream 0 using template query20.tpl--I am here
...
-- end query 66 in stream 0 using template query88.tpl--I am here
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-01-21' as date) and  DATE_ADD(cast('1999-01-21' as date), INTERVAL 60 DAY)  
 and i_manufact_id in (73,686,513,848)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
-- end query 67 in stream 0 using template query82.tpl--I am here
...
-- end query 68 in stream 0 using template query23.tpl--I am here
...
-- end query 69 in stream 0 using template query14.tpl--I am here
...
-- end query 70 in stream 0 using template query57.tpl--I am here
...
-- end query 71 in stream 0 using template query65.tpl--I am here
...
-- end query 72 in stream 0 using template query71.tpl--I am here
...
-- end query 73 in stream 0 using template query34.tpl--I am here
...
select sum (ss_quantity)
 ...
 or
  ...
  ca_country = 'United States'
  and
  ca_state in ('KS', 'AR', 'PA')
  and ss_net_profit between 50 and 25000 
  )
 )
;

-- end query 74 in stream 0 using template query48.tpl--I am here
...
-- end query 75 in stream 0 using template query30.tpl--I am here
...
-- end query 76 in stream 0 using template query74.tpl--I am here
...
-- end query 77 in stream 0 using template query87.tpl--I am here
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-06' as date) 
                  and DATE_ADD(cast('1999-08-06' as date) ,INTERVAL  30 day) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- end query 78 in stream 0 using template query77.tpl--I am here
...
-- end query 79 in stream 0 using template query73.tpl--I am here
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oak Grove'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  39791
   and ib_upper_bound   <=  39791 + 50000
...
-- end query 80 in stream 0 using template query84.tpl--I am here
...
-- end query 81 in stream 0 using template query54.tpl--I am here
...
-- end query 82 in stream 0 using template query55.tpl--I am here
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('coral','lime','antique'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 1
...
-- end query 83 in stream 0 using template query56.tpl--I am here
...
-- end query 84 in stream 0 using template query2.tpl--I am here
...
-- end query 85 in stream 0 using template query26.tpl--I am here
...
-- end query 86 in stream 0 using template query40.tpl--I am here
...
-- end query 87 in stream 0 using template query72.tpl--I am here
...
-- end query 88 in stream 0 using template query53.tpl--I am here
...
-- end query 89 in stream 0 using template query79.tpl--I am here
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,12,11,6,2,4) and
       d_year = 2001 and
       ca_state in ('KS','IN','KY'
                   ,'IA','MT','TX','OR')
...
-- end query 90 in stream 0 using template query18.tpl--I am here
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'VT', 'AL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'ND', 'OK')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'ID', 'AZ')
  and ss_net_profit between 50 and 250  
     ))
;

-- end query 91 in stream 0 using template query13.tpl--I am here
...
-- end query 92 in stream 0 using template query24.tpl--I am here
...
-- end query 93 in stream 0 using template query4.tpl--I am here
...
-- end query 94 in stream 0 using template query99.tpl--I am here
...
-- end query 95 in stream 0 using template query68.tpl--I am here
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-03-18','2001-08-18','2001-11-23')))
...
-- end query 96 in stream 0 using template query83.tpl--I am here
...
-- end query 97 in stream 0 using template query61.tpl--I am here
...
-- end query 98 in stream 0 using template query5.tpl--I am here
...
-- end query 99 in stream 0 using template query76.tpl--I am here
